...
export class ResNet50V2Nchw {
	constructor() {
		...
		this.weightsUrl_ =
			weightsOrigin() + "/test-data/models/resnet50v2_nchw/weights/";
		this.inputOptions = {
	...
	async buildBottlenectV2_(
		...
		const bn2 = this.buildBatchNorm_(
			conv1,
			parseInt(nameIndices[0]) + 1,
			stageName,
		);
		const conv2 = this.buildConv_(bn2, nameIndices[2], stageName, {
			padding: [1, 1, 1, 1],
			strides,
		});
		const bn3 = this.buildBatchNorm_(
			conv2,
			parseInt(nameIndices[0]) + 2,
			stageName,
		);
	...
	async load(contextOptions) {
		...
		const conv0 = this.buildConv_(bn1, "0", "", {
			padding: [3, 3, 3, 3],
			strides: [2, 2],
		});
		...
		const bottleneck2 = this.buildBottlenectV2_(bottleneck1, "1", [
			"3",
			"4",
			"5",
			"6",
		]);
		const bottleneck3 = this.buildBottlenectV2_(bottleneck2, "1", [
			"6",
			"7",
			"8",
			"9",
		...
		const bottleneck5 = this.buildBottlenectV2_(bottleneck4, "2", [
			"3",
			"4",
			"5",
			"6",
		]);
		const bottleneck6 = this.buildBottlenectV2_(bottleneck5, "2", [
			"6",
			"7",
			"8",
			"9",
		]);
		const bottleneck7 = this.buildBottlenectV2_(bottleneck6, "2", [
			"9",
			"10",
			"11",
			"12",
		...
		const bottleneck9 = this.buildBottlenectV2_(bottleneck8, "3", [
			"3",
			"4",
			"5",
			"6",
		]);
		const bottleneck10 = this.buildBottlenectV2_(bottleneck9, "3", [
			"6",
			"7",
			"8",
			"9",
		]);
		const bottleneck11 = this.buildBottlenectV2_(bottleneck10, "3", [
			"9",
			"10",
			"11",
			"12",
		]);
		const bottleneck12 = this.buildBottlenectV2_(bottleneck11, "3", [
			"12",
			"13",
			"14",
			"15",
		]);
		const bottleneck13 = this.buildBottlenectV2_(bottleneck12, "3", [
			"15",
			"16",
			"17",
			"18",
		...
		const bottleneck15 = this.buildBottlenectV2_(bottleneck14, "4", [
			"3",
			"4",
			"5",
			"6",
		]);
		const bottleneck16 = this.buildBottlenectV2_(bottleneck15, "4", [
			"6",
			"7",
			"8",
			"9",
