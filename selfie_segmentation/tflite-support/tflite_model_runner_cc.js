var tflite_model_runner_ModuleFactory = (() => {
	...
	return function (tflite_model_runner_ModuleFactory) {
		...
		var wasmBinaryFile;
		wasmBinaryFile = "tflite_model_runner_cc.wasm";
		...
		init_emval();
		var asmLibraryArg = {
			X: __ZN6tflite13DumpArenaInfoERKNSt3__212basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEERKNS0_6vectorIiNS4_IiEEEEmRKNS9_INS_27ArenaAllocWithUsageIntervalENS4_ISE_EEEE,
			P: __dlinit,
			R: __dlopen_js,
			Q: __dlsym_js,
			C: __embind_finalize_value_object,
			...
			B: __emval_new,
			q: __emval_new_array,
			y: __emval_new_array_from_memory_view,
		...
		var _malloc = (Module["_malloc"] = function () {
			return (_malloc = Module["_malloc"] = Module["asm"]["aa"]).apply(
				null,
				arguments,
			);
		});
