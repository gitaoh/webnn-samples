...
document.addEventListener("DOMContentLoaded", async(e) => {
	...
	await test("[12.34]f32", {
		dataType: "float32",
		shape: [1],
		buffer: [Math.fround(12.34)],
	});
	await test("[12.34]f16", {
		dataType: "float16",
		shape: [1],
		buffer: [12.34375],
	});
	...
	await test("A = [[1,7],[2,4]]  B = [[3,3],[5,2]]  matmul(A,B)", {
		dataType: "float32",
		shape: [2, 2],
		buffer: [38, 17, 26, 14],
	});
	await test("M = [[2,8,3],[5,4,1]]  N = [[4,1],[6,3],[2,4]]  matmul(M,N)", {
		dataType: "float32",
		shape: [2, 2],
		buffer: [62, 38, 46, 21],
	});
	...
	await test("linear(10, {})", {
		dataType: "float32",
		shape: [],
		buffer: [10],
	});
	await test("linear(10, {alpha: 2, beta: 3})", {
		dataType: "float32",
		shape: [],
		buffer: [23],
	});
	...
	await test("A = [1,2]  B = [3,4]  concat([A,B], 0)", {
		dataType: "float32",
		shape: [4],
		buffer: [1, 2, 3, 4],
	});
	await test("concat([identity([1,2]),identity([3,4])], 0)", {
		dataType: "float32",
		shape: [4],
		buffer: [1, 2, 3, 4],
	});
	...
	await test("T = [[1,2,3],[4,5,6]]  reshape(T, [1, 3, 2, 1])", {
		dataType: "float32",
		shape: [1, 3, 2, 1],
		buffer: [1, 2, 3, 4, 5, 6],
	});
	await test("expand([1], [2, 2])", {
		dataType: "float32",
		shape: [2, 2],
		buffer: [1, 1, 1, 1],
	});
	...
	await test("A = [[1,2], [3,4]]  B = [[5,6], [7,8]]  gemm(A, B, {c: 123})", {
		dataType: "float32",
		shape: [2, 2],
		buffer: [142, 145, 166, 173],
	});
	await test(
	...
	await test("concat([[1,2],[3,4]], 0)", {
		dataType: "float32",
		shape: [4],
		buffer: [1, 2, 3, 4],
	});
	await test("trueblue = 123  (trueblue) + 1", {
		dataType: "float32",
		shape: [],
		buffer: [124],
	});
	await test("InfinityGauntlet = 123  (InfinityGauntlet) + 1", {
		dataType: "float32",
		shape: [],
		buffer: [124],
	});
	await test("NaNBread = 123  (NaNBread) + 1", {
		dataType: "float32",
		shape: [],
		buffer: [124],
	});
